...
\mode<presentation>
{
  \definecolor{ctpred}{RGB}{0,30,90}
  \definecolor{ctporange}{RGB}{235,55,80}
...
\begin{frame}
  ...
  \begin{description}
    ...
    \begin{itemize} 
      \item Swagger 
      \begin{center}
        \includegraphics[height=0.33\textheight]{images/swagger}
      \end{center}
      \item Plugin Json Firefox
      \item Json Viewer
      \item codebeautify.org/jsonviewer
      \item ...
    \end{itemize}
  \end{description}
\end{frame}
