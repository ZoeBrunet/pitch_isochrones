...
\begin{frame}
  ...
  \begin{description}
    \item[Concurrents qui ont déjà des solutions similaires: ]
  \end{description}
  \begin{itemize}
  ...
  \end{itemize}
    \begin{description}
    \item[Concurrents qui n'ont pas de solutions similaires: ]
  \end{description}
  \begin{itemize}
...
\begin{frame}
  ...
  Freemium, paliers de consomation, accès aux services.
...
\begin{frame}
  ...
  \item intégré rapidemnt à Kisio Digital.
  \end{itemize}
\end{frame}
